...
class ResNet(nn.Module):
    def __init__(self, last_stride, bn_norm, with_ibn, with_se, with_nl, with_in,
                 with_srm, with_csrm, block, layers, non_layers, pretrained,
        ...
        if not self.cut_at_pooling:
            ...
            # if self.num_classes:
            #     self.n_source = len(self.num_classes)
...
def resnet_mde(depth, pretrained=True, cut_at_pooling=False,
    ...
    model = ResNet(last_stride, bn_norm, with_ibn, with_se, with_nl, with_in, with_srm, with_csrm,
